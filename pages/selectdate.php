       ...
       <?php include('header.php');?>
                           ...
                           <!-- /.box -->
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row col-sm-offset-2" style="padding-left:5px;">
                                        <p style="padding-left:10px;">or</p>
                                        <a href="allRec.php" class="btn btn-primary" role="button">View all records</a>
                                    </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
        ...
        <script type="text/javascript">
            $(function() {
              ...
              var optionm;
              var moption=["January","February","March","April","May","June","July","August","September","October","November","December"];
              for (var month = 0; month<=11; month++) {
                var mvalue = month+1;
                optionm += "<option value="+String((mvalue<10)?"0"+mvalue:mvalue)+">"+moption[month]+"</option>";
              }
              document.getElementById("month").innerHTML = optionm;
